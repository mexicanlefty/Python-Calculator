...
except (ModuleNotFoundError, ImportError):    # Python 2.7.x
    from Tkinter import *
...
def sum_click():
    ...
    if operation_number == 0:
        ...
        if current_number_sum != "":
            ...
            messagebox.showerror('Empty Fields', 'No number given')
...
def division_click():
    ...
    if operation_number == 0:
        ...
        try:
            ...
            messagebox.showerror('ZeroDivisionError', 'Cannot divisible by 0')
...
def toPowerof():
    ...
    if current_number_power != "":
        ...
        messagebox.showerror('Invalid Entry', 'Please input any number')
...
def positive_negative():
    try:
        ...
        messagebox.showerror('Invalid Integer', 'No number is inputed')
...
def delete():
    try:
        ...
        messagebox.showinfo('Fields Empty', 'All numbers/operators are cleared already')
...
def add_point():
    ...
    if "." in current_number:
        messagebox.showinfo('Error Deicmal Place', 'Decimal point already added')
...
def equals_click():
    ...
    if operation_number == 0:
        e.insert(0, current_number)
        messagebox.showerror('Invalid Calculation', 'Input numbers to make any calculation')
